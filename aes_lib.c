...
static uint8_t* init_key(uint8_t* ps);
...
int _aes128_encryption(unsigned char* key,unsigned char* ciphertext, unsigned char* plaintext)
{
...
int _aes128_decryption(unsigned char* key, unsigned char* plain_text, unsigned char* cypher)
{
